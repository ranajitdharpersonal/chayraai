      ...
      if (data.type === 'success' || data.type === 'spam') {
        ...
        if (data.type === 'success') {
            ...
            const actionData = {
                ...
                intel: data.radarIntel,
                route: data.navigation ? data.navigation.text : "Standby for routing protocols.",
                destCoords: data.navigation ? data.navigation.destCoords : null,
                medical: data.medical || ["Standby for medical triage."],
                vault: data.vault || "Identity standby.",
